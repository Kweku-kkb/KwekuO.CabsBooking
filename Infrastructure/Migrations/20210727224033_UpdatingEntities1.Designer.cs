...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20210727224033_UpdatingEntities1")]
    partial class UpdatingEntities1
    {
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Bookings", b =>
                {
                    ...
                    b.Property<int?>("ToplaceFKPlaceId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Bookings", b =>
                {
                    ...
                    b.HasOne("ApplicationCore.Entities.Places", "FromPlaceFK")
                        .WithMany("Bookings")
                        .HasForeignKey("FromPlace");

                    b.HasOne("ApplicationCore.Entities.Places", "ToplaceFK")
                        .WithMany()
                        .HasForeignKey("ToplaceFKPlaceId");

                    b.Navigation("CabType");

                    b.Navigation("FromPlaceFK");

                    b.Navigation("ToplaceFK");
                });
